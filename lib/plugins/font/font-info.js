...
.defines(function(){
    ig.FontInfo = ig.Class.extend({
        ...
        fonts: [
            {name: 'montserrat-regular', source: 'media/fonts/montserrat-regular'},
            {name: 'montserrat-medium', source: 'media/fonts/montserrat-medium'},
            {name: 'montserrat-bold', source: 'media/fonts/montserrat-bold'}
        ],
